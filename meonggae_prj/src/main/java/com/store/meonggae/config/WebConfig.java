...
import com.store.meonggae.user.login.interceptor.LoginCheckInterceptor;
...
public class WebConfig implements WebMvcConfigurer {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		registry.addInterceptor(loginCheckInterceptor).order(0)
				.addPathPatterns("/product_page/product_add.do", "/My/store/store_frm.do", "/meongae_talk/talk_page.do")
				.excludePathPatterns("/index.do/logout.do");
	}
