...
public class EventDomain {
	private int cnt;
	private String eventNum, title, writer, content, start_date, end_date, img;
	...
	public String toString() {
		return "EventDomain [cnt=" + cnt + ", eventNum=" + eventNum + ", title=" + title + ", writer=" + writer
				+ ", content=" + content + ", start_date=" + start_date + ", end_date=" + end_date + ", img=" + img
				+ "]";
	}
