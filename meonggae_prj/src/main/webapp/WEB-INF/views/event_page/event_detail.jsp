        ...
        <div class="container" style="height:1000px;">
            <table class="table table-hover" style="width: 100%;">
                <tr>
                    ...
                    <th style="width: 5%"><a href="${pageContext.request.contextPath}/event_page/event_main.do">목록으로</a></th>
                </tr>
                <tr>
                    <td colspan="5">
                        <img src="${pageContext.request.contextPath}/common/images/event${eventDetail.img}" style="width: 100%; height: 500px;">
                        ${eventDetail.content}
                    </td>
                </tr>
            </table>
