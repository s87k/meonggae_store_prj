    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-sm-3">
                <div class="logo">
                    <a href="http://localhost//meonggae_prj/index.do">
                        <img src="http://localhost/meonggae_prj/common/images/meonggaelogo.png">
                    </a>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-4">
                <div class="col-md-4 col-sm-4">
                    <a href="http://localhost//meonggae_prj/product_page/product_add.do" class="icons">
                        <img src="http://localhost/meonggae_prj/common/images/meonggaesale.png" alt="판매하기 이미지">
                ...
                <div class="col-md-4 col-sm-4">
                    <a href="http://localhost//meonggae_prj/meongae_talk/talk_page.do" class="icons">
                        <img src="http://localhost/meonggae_prj/common/images/meonggaeTalk.png" alt="멍게톡 이미지">
